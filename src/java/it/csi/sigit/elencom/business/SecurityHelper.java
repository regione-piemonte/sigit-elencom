...
public class SecurityHelper {
	...
	protected it.csi.sigit.elencom.dto.common.UserInfo getCurrentUserInfo(Map session) throws BEException {
		it.csi.sigit.elencom.dto.common.UserInfo userInfo = (it.csi.sigit.elencom.dto.common.UserInfo) session
	...
	public static final Application IRIDE2_APPLICATION = new Application("");
	...
	public boolean verifyCurrentUserForUC(Map session, String useCaseCode) throws BEException {
		...
		try {
			it.csi.sigit.elencom.dto.common.UserInfo currentUserInfo = getCurrentUserInfo(session);
